...
namespace RealEstateAgency
{
    public partial class Form1 : Form
    {
        ...
        {
            OpenChildForm(new Forms.FormApartments(), sender);
        }

        private void btnRealtors_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.FormRealtors(), sender);
        }

        private void btnTransactions_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.FormTransactions(), sender);
        }
